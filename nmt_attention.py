...
# converts text data into shape (m,50,50) where:
# m = number of to_sentences
# 50 words per sentences
# 50 dimensional glove vector per word
# def preprocess_text(filename,word_to_vec_map,maxlen=50):
#
#     sentences = load_clean_sentences(filename)
#     sentences = uniform_sentences(sentences,maxlen)
#     sentences = chuck_nonglove(sentences,word_to_vec_map)
#     sentences = to_glove_vectors(np.array(sentences),word_to_vec_map)
#
#     return sentences
...
EXAMPLES = ['3 May 1979', '5 April 09', '21th of August 2016', 'march of 2nd 2018', 'Saturday May 9 2018', 'March 3 2001', 'March 3rd 2001', '1 March 2001']
