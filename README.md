...
Where T<sub>x</sub> is the number of words in the input, and a<sup>t'</sup> is a concatenation of the forward and backward activation vectors of the input layer.
